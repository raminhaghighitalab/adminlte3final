            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"> {{$information->likes ?? null }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"> {{$information->sales ?? null }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"> {{$information->new_members ?? null }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
...
{{--                                <div class="card-body">--}}
                                    <div class="chart">
                                        <canvas id="areaChart"
                                                style="min-height: 200px; height: 200px; max-height: 200px; max-width: 170%; width: 170%"></canvas>
                                    </div>
{{--                                </div>--}}
                                <!-- /.card-body -->
                            </div>
                            ...
                            <table class="table m-0">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        <td><a>{{$order->id}}</a></td>
                                        <td>{{$order->item}}</td>
                                        <td><span class="badge badge-{{$order->color}}">{{$order->status}}</span></td>
                                        <td>
                                            <div class="sparkbar" data-color="#00a65a"
                                                 data-height="20">{{$order->Popularity}}</div>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
